...
if (!contact.includes("NOT_YET_AVAILABLE") || contact.includes("alert(")) fail("WEB6", "fake contact success remains");
pass("WEB6", "contact form disabled without fake success");
...
if (!chat.includes("TURNSTILE_SECRET_KEY") || !chat.includes("cost_circuit_open") || !widget.includes("privacy_acknowledged")) {
  fail("WEB12", "AI abuse/privacy controls missing");
}
pass("WEB12", "AI fail-closed, Turnstile, privacy, cost breaker");
